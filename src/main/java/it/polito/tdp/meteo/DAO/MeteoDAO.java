...
public class MeteoDAO {
	...
	//public List<Rilevamento> getAllRilevementiLocalitaMese(int mese, String localita){
	/**
	...
	/**
	 * Dato un mese e una città estrarre dal DB l'umidità media relativa a tale mese etale città
	 * (tutti calcoli sono delegati al database)
	 * @param mese
	 * @param citta
	 * @return
	 */
