...
public class Model {
	...
	/**
	 * Calcolo dell'umidità media in una città in un mese
	 * @param mese
	 * @param citta
	 ...
	 * @return la lista delle citta da visitare nei primi 15 giorni del mese
	 */
	 ...
	 * Per informazioni sull'impostazione della ricorsione, vedere il file logica_delle_ricorsioni.txt
	 * nella cartella del progetto
	 * @param parziale soluzione parziale in via di costruzione
	 * @param livello livello della ricorsione, cioè il giorno in cui si sta cercando di definire la città
	 */
	 ...
	 * 
	 * Stiamo facendo l'assunzione semplificativa che tutti i dati/giorni del mese siano presenti nel database
	 ...
	 * 
	 * @param prova la citta che sto cercando di raggiungere
	...
	private boolean aggiuntaValida(Citta prova, List<Citta> parziale) {
		...
		if(parziale.size()==0) //primo giorno posso inserire qualsiasi citta
			return true;
		...
		//quindi nei giorni successivi ai primi tre posso sempre rimanere
